            ...
            <div class="col-lg-10">
                ...
                <div class="alert alert-success main_thank">
                    ...
                    <div class=" text-center my-4 pt-4">
                        <a href="{{ route('login') }}" class="btn btn-primary vs-btn vs-btn-2 mx-3">Login <i class="far fa-long-arrow-right"></i></a>
                        <a href="{{ url('/') }}" class="btn btn-secondary vs-btn">Back to Home Page <i class="far fa-long-arrow-right"></i></a>
                    </div>
                </div>
                <div class="col-lg-1"></div>
            </div>
                    ...
                    <div class="download-box">
                        <div class="Corporate-membership ">
                            ...
                            <a href="{{ asset('forms/psc-application-form-new.pdf') }}" download>
                                <button class="vs-btn vs-btn-2 style3 view-btns mt-4">Download <i class="far fa-long-arrow-right"></i></button>
                            </a>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-12">
                                <div class="textbox">
                                    ...
                                    <input type="text" id="name" class="form-control" name="name" placeholder="Enter your name" value="{{ old('name') }}" maxlength="50" required>
                                    @error('name')
                            ...
                            <div class="col-lg-6">
                                <div class="textbox">
                                    ...
                                    <input type="email" id="email" class="form-control" name="email" value="{{ old('email') }}" placeholder=" Your email" maxlength="50" required>
                                    @error('email')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="textbox">
                                    ...
                                    <input type="text" id="number" class="form-control" name="number" value="{{ old('number') }}" placeholder="Enter Your Contact Number" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" required>
                                    @error('number')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="textbox">
                                    ...
                                    <input type="password" id="password" class="form-control" name="password" maxlength="50" value="{{ old('password') }}" placeholder="********" required>
                                    @error('password')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-6">
                                <div class="textbox">
                                    <label for="confirmed">Confirmation Password<span class="text-danger">*</span></label>
                                    <input type="password" id="confirmed" class="form-control" name="password_confirmation" value="{{ old('confirm_password') }}" placeholder="*******" maxlength="50" required>
                                    @error('confirmed')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="col-lg-12">
                                <div class="textbox mb-0">
                                    ...
                                    <input type="file" id="form_pdf" class="form-control" name="form_pdf" accept="application/pdf" required>
                                    @error('form_pdf')
                                    <span class="text-danger">{{ $message }}</span>
                                    @enderror
                            ...
                            <div class="col-lg-12">
                                <p class="text-danger " style="font-size: 14px; font-size: 14px;
