                    ...
                    @if (auth()->user()->id !== 1)
                        <div class="card radius-10">
                            <div class="card-body">
                                ...
                                <button class="btn btn-danger btn-sm text-light mb-3" id="statusProfileBtn" type="button">
                                    <ion-icon name="close"></ion-icon>
                                    De-active Account
                                </button>
                                <button class="btn btn-danger btn-sm text-light mb-3" id="deleteProfileBtn" type="button">
