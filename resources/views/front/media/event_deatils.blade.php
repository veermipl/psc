                    ...
                    <div class="blog-classic-content">
                        ...
                        <div class="blog-classic-single mb-30">
                            ...
                            <div class="blog-classic-content-box mb-15">
                               ...
                               @if($details->loaction != '') 
                                    <li><a href="#">
                                        <i class="far fa-calendar" aria-hidden="true"></i> 17/09/2024 &nbsp; 04:12pm</a>
                                    </li>
                                @endif
                            ...
                            @foreach($events as $data)
                                <li>
                                    ...
                                    <div class="sidebar-latest-news-content">
                                       <h3><a href="{{route('media.event_details', base64_encode($data->id))}}">{{$data->title}}</a></h3>
                                       <p>02 May, 2020</p> 
                                    </div>
                                </li>
                            @endforeach
        ...
        <div class="portfolio-one-content">
            <div class="sortable-masonry"> 
                 <div class="row items-container" style="position: relative; height: 590px;">
                     ...
                     <div class="col-xl-3 col-lg-3 col-md-6 masonry-item all mechanical chemical material" style="position: absolute; left: 0px; top: 0px;">
                         <div class="portfolio-one-single">
                             <div class="portfolio-one-img-box">
                                 ...
                                 <div class="portfolio-two-icon-box">
                                     <a href="{{ asset('storage/' . $fileValue) }}" class="img-popup"><i class="fa fa-search"></i></a>
