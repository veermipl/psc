...
@section('content')
    ...
    <section class="testimonials-one-section two"
        style="background-image: url('{{ asset('images/testimonial/bg-back.png') }}');">
        <div class="container">
            <div class="thm-section-title text-center">
    ...
    <section class="blog-one-section section-back">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-md-4 col-lg-4 process-style2">
                    <div class="process-arrow"><img src="{{ asset('images/arrow-icon/process-arrow-2-1.png') }}"
                            alt="arrow"></div>
                    <div class="process-icon">
                    ...
                    <p class="process-text">The PSC strives to ensure that opportunities are capitalized upon, and
                        solutions
