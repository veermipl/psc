                 ...
                 <div class="back-ground">
                     ...
                     <div class="breadcrumbs text-center wow animate__ animate__fadeInUp animate__delay-1s animated" style="visibility: visible; animation-name: fadeInUp;">
                         <ul>
                             ...
                             <li><a href="{{ route('about-us.committeess') }}">Executive Committees</a></li>
                         </ul>
                     </div>
                 </div>
             </div>
      ...
      <section class="blog-one-section">
        <div class="container">
            <div class="thm-section-title text-center">
                ...
                <h2>Executive Committees Members</h2>
            </div>

            @if(count(@$executive_committees) > 0)
                <div class="row">
                    @foreach($executive_committees as $members)
                        <div class="col-xl-3 col-lg-3 col-md-6">
                            <div class="team-one-single wow fadeInLeft animated" data-wow-delay="100ms" style="visibility: visible; animation-delay: 100ms; animation-name: fadeInLeft;">
                                    ...
                                    <div class="team-one-hover">
                                        <div class="team-one-social">
                                            ...
                                            @if($members->instagram)
                                                <a href="{{$members->instagram}}"><i class="fab fa-instagram"></i></a>
                                            @endif
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="team-one-content pt-0 d-none">
                                    <a href="{{ route('about-us.executive-committeess-show', $members->id) }}" class="vs-btn1 style5 mt-3" tabindex="0">
