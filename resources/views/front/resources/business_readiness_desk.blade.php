    ...
    <section class="features-two-section">
        <div class="container">
            ...
            <div class="row">
                ...
                <div class="col-lg-4 col-md-6">
                    <!--Features One Sec Single-->
                    <div class="features-two-sec-single wow fadeInUp h-100 animated" data-wow-delay="600ms"
                        style="
                  visibility: visible;
                ...
                <div class="col-lg-4 col-md-6">
                    <!--Features One Sec Single-->
                    <div class="features-two-sec-single wow fadeInUp h-100 animated" data-wow-delay="900ms"
                        style="
                  visibility: visible;
