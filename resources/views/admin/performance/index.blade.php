...
@section('content')
    ...
    <div class="p-3 bg-white">
        <h5 class="fw-bold">Performance List</h5>
        ...
        <div class="filter-wrapper my-3 p-3">
            <form action="#" method="post">
                ...
                <div class="text-right">
                    <a href="{{ route('admin.cms.performance') }}" class="btn btn-danger btn-sm">Reset</a>
        ...
        <div class="d-flex justify-content-between py-3 d-none">
            <a href="{{ route('admin.cms.add_performance') }}">
                                ...
                                <td>
                                    <div class="tableOptions">
                                        <span class="text-dark" title="Edit">
                                            <a href="{{ route('admin.cms.performance_edit', $user->id) }}"><i
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', '#userStatus', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('admin.cms.performance_status') }}",
                            method: 'POST',
                            data: {
                                _method: 'post',
                                _token: '{{ csrf_token() }}',
            ...
            $(document).on('click', '#deleteUserBtn', function(e) {
                ...
                var uid = $(this).attr('uid');
                var urow = $(this).attr('urow');
                var url = `{{ url('/admin/cms/destroy-performance/${uid}') }}`;
