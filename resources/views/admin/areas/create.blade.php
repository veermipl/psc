...
@section('title', 'Create Key Areas of Focus')
@section('header', 'Create Key Areas of Focus')

@section('content')

    <div class="page-breadcrumb d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Create Key Areas of Focus  </div>
    </div>
            ...
            <div class="card radius-10">
                <div class="card-body">
                    <div class="p-4 border rounded">
                        <form action="{{ route('admin.readines.areas.store') }}" method="post" enctype="multipart/form-data" class="row g-3 needs-validation">
                            @csrf
                            @method('post')
