...
@section('title', 'Landing Page - Update Sector Committee')
@section('header', 'Landing Page - Update Sector Committee')

@section('content')

    <div class="page-breadcrumb d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Landing Page - Update Sector Committee</div>
    </div>
            ...
            <div class="card radius-10">
                <div class="card-body">
                    <div class="p-4 border rounded">
                        <form action="{{ route('admin.cms.landing-page.update.sector-committee') }}" method="post"
