...
@section('title', 'Committees Members- Create')
@section('header', 'Create Committeess Members')
            ...
            <div class="card radius-10">
                <div class="card-body">
                    <div class="p-4 border rounded">
                        <form action="{{ route('admin.committeess.store') }}" method="post" enctype="multipart/form-data"
