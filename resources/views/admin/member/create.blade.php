                        ...
                        <form action="{{ route('admin.member.store') }}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="col-md-6 position-relative">
                                ...
                                <input type="email" id="email" class="form-control" name="email"
                                    value="{{ old('email') }}" placeholder="Enter email" maxlength="50">
                            ...
                            <div class="col-md-6 position-relative">
                                <label for="validationTooltip01" class="form-label">Upload Filled Form <span
                                        class="text-danger">*</span></label>
                                <input type="file" id="form" class="form-control" name="form"
                            ...
                            <div class="col-md-6 position-relative">
                                <label for="validationTooltip01" class="form-label">Upload Supporting Documents <span
                                        class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6 position-relative">
                                <label for="validationTooltip01" class="form-label">Confirm Password <span
                                        class="text-danger">*</span></label>
