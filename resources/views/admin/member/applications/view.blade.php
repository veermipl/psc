        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card radius-10">
                    <div class="card-body">
                        <div class="page-breadcrumb d-sm-flex justify-content-between m-0">
                            <div class="breadcrumb-title-2 pe-3"><b> Application for Membership </b> </div>
                            <div class="text-end">
                                <div class="col-lg-12 mb-3">
                                    <div class="">
                                        <a href="{{ route('admin.member.print', $id) }}" target="_blank" class="btn btn-primary btn-sm">
                                            <ion-icon name="print" role="img" class="md hydrated" aria-label="person add"></ion-icon>
                                            Print
                                        </a>
                                        <a href="{{ route('admin.member.download-pdf', $id) }}" class="btn btn-primary btn-sm">
                                            <ion-icon name="document-outline" role="img" class="md hydrated" aria-label="person add"></ion-icon>
                                            PDF
                                        </a>
                                    </div>
                                </div>
                        ...
                        <div class="p-4 border rounded">
                            <div class="row ">
                                ...
                                <div class="col-lg-4"> <b>Application Type: </b> {{ $data->busibessType->name ?? '' }}
                                </div>
                        ...
                        <div class="p-4 border rounded">
                            <div class="row ">
                                ...
                                <div class="col-lg-4"> <b>Date of Registration : </b>
                                    {{ date('d-m-Y', strtotime($data->date_of_egistration ?? '')) }} </div>
                                <div class="col-lg-4"> <b>Type of Business or State: </b> {{ $data->sectors->name ?? '' }}
                                </div>
                        ...
                        <div class="p-4 border rounded">
                            <div class="row ">
                                ...
                                <div class="col-lg-4"> <b>Registered Office Address: </b>
                                    {{ $data->registered_office_address ?? '' }} </div>
                                <div class="col-lg-4"> <b> Business/ Operation Address: </b>
                                    {{ $data->type_of_business ?? '' }} </div>
                            </div>
                        </div>
                      ...
                      <div class="row ">
                        ...
                        <div class="p-4 border rounded">
                            <div class="row ">
                                ...
                                <div class="col-lg-4"> <b>Wish to Become a Member of the PSC : </b>
                                    {{ $data->state_briefly ?? '' }} </div>
                                <div class="col-lg-4"> <b>How do you know about the PSC: </b>
                                    {{ $data->you_know_about ?? '' }} </div>
                            </div>
                        </div>
                        ...
                        <div class="p-4 border rounded">
                            <div class="row ">
                                <div class="col-lg-4"> <b>Date: </b>
                                    {{ date('d-m-Y', strtotime($data->principal_date ?? '')) }} </div>

                                <div class="col-lg-4">
                                    <b>Uploaded Files: </b>
                                    @foreach ($docVal as $key => $docsArr)
                                        <span class="text-center pdf-files">
                                            <a href="{{ $docsArr->file_name ? asset('storage/' . $docsArr->file_name) : '' }}"
                                                target="_blank" title="Filled Form"> <i class="fa fa-file text-dark"></i>
                                            </a>
                                        </span>
                                    @endforeach
                                </div>
