...
@section('title', 'IDB Investment Services')
@section('header', 'IDB Investment Services')

@section('content')

    <div class="p-3 bg-white">
        <h5 class="fw-bold">IDB Investment Services List</h5>
        ...
        <div class="filter-wrapper my-3 p-3">
            <form action="#" method="post">
                ...
                <div class="text-right">
                    <a href="{{ route('admin.readines.IDB_Investment') }}" class="btn btn-danger btn-sm">Reset</a>
                                ...
                                <td>
                                    <div class="tableOptions">
                                        <span class="text-dark" title="Edit">
                                            <a href="{{ route('admin.readines.IDB.edit', $user->id) }}"><i
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', '#deleteUserBtn', function(e) {
                ...
                var uid = $(this).attr('uid');
                var urow = $(this).attr('urow');
                var url = `{{ url('/admin/readines/idb-investment-destroy/${uid}') }}`;
