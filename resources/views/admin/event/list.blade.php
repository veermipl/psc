...
@section('content')
    <div class="page-breadcrumb d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Event List</div>
    </div>
        ...
        <div class="col-lg-12 mb-3">
            <div class="d-flex justify-content-between">
                <a href="{{ route('admin.event.create') }}" class="btn btn-primary btn-sm">
                    <ion-icon name="add" role="img" class="md hydrated" aria-label="person add"></ion-icon>Create event
                </a>
            ...
            <div class="card radius-10 w-100">
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        <table id="newsTable" class="table table-sm table-borderless table-light" data-toggle="table"
                                            ...
                                            <td>
                                                <div class="tableOptions">
                                                    <span class="text-dark" title="Edit">
                                                        <a  href="{{ route('admin.event.edit', $listValue->id) }}"><i class="fa fa-pencil"></i></a>
                                                    </span>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', '#deleteListBtn', function(e) {
                ...
                var lid = $(this).attr('lid');
                var lrow = $(this).attr('lrow');
                var url = `{{ url('/admin/event/delete/${lid}') }}`;
