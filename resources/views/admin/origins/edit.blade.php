...
@section('title', 'Certificate of Origins - List')
@section('header', 'Certificate of Origins')

@section('content')

    <div class="page-breadcrumb d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Certificate of Origins Data</div>
    </div>
                    ...
                    <div class="p-4 border rounded">
                        ...
                        <div id="" class="pt-4">
                            <div class="collapse sub_page_body {{ $tab == 'main' ? 'show' : 'hide' }}"
                                ...
                                <form action="{{ route('admin.readines.origins.certificate_update') }}" method="post" enctype="multipart/form-data" class="row g-3 needs-validation">
                                    @csrf
                                    @method('post')
                                    ...
                                    <input type="hidden" name="type" value="Origins">
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-3">
                                        <div class="d-flex justify-content-between">
                                            <a href="{{ route('admin.readines.origins.add') }}"
                                                class="btn btn-primary btn-sm">
                                                <ion-icon name="add" role="img" class="md hydrated"
                                                    aria-label="person add"></ion-icon>Create Types of Certificates of Origin 
                                            </a>
                                                            ...
                                                            <td>
                                                                <div class="tableOptions">
                                                                    <span class="text-dark" title="Edit">
                                                                        <a
                                                                            href="{{ route('admin.readines.origins.edit', $listValue->id) }}">
                            ...
                            <div class="collapse sub_page_body {{ $tab == 'top_country' ? 'show' : 'hide' }}"
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-3">
                                        <div class="d-flex justify-content-between">
                                            <a href="{{ route('admin.readines.origins.certificate.add') }}"
                                                class="btn btn-primary btn-sm">
                                                <ion-icon name="add" role="img" class="md hydrated"
                                                    aria-label="person add"></ion-icon>Create Certificate of Origin
                                            </a>
                                                        ...
                                                        <tr class="tr_row_{{ $listKey }}">
                                                            ...
                                                            <td>
                                                                <div class="tableOptions">
                                                                    <span class="text-dark" title="Edit">
                                                                        <a
                                                                            href="{{ route('admin.readines.origins.certificate.edit', $listValue->id) }}">
                                                                            <i class="fa fa-pencil"></i>
                                                                        </a>
                                                                    </span>
                                                                    <span class="text-danger" title="Delete"
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', '#listStatus', function(e) {
                ...
                // alert(ltype);
                var url = null;
                if (ltype == 'Origins_certificate') {
                    url = "{{ route('admin.readines.origins.status') }}";
                }
                if (ltype == 'Origins_of_certificates') {
                    url = "{{ route('admin.readines.origins.certificate.status') }}";
                }
            ...
            $(document).on('click', '#deleteListBtn', function(e) {
                ...
                var url = null;
                if (ltype == 'Origins_certificate') {
                    url = "{{ route('admin.readines.origins.destroy') }}";
                }
                if (ltype == 'Origins_of_certificates') {
                    url = "{{ route('admin.readines.origins.certificate.destroy') }}";
                }
