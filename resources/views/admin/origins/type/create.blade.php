...
@section('title', 'About - Types of Certificates of Origin')

@section('content')

    <div class="p-3 bg-white">
        <h5 class="fw-bold">Create Types of Certificates of Origin</h5>

        <div class="pt-5">
            <form action="{{ route('admin.readines.origins.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('post')
                <div class="d-flex">
