...
@section('title', 'Certificates of origin')

@section('content')

    <div class="p-3 bg-white">
        <h5 class="fw-bold">Edit Certificates of origin</h5>

        <div class="pt-5">
            <form action="{{ route('admin.readines.certificate.update', $data->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('patch')
                <div class="d-flex">
