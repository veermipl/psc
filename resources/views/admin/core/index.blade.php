...
@section('content')
    ...
    <div class="p-3 bg-white">
        <h5 class="fw-bold">core value List</h5>
        ...
        <div class="filter-wrapper my-3 p-3">
            <form action="#" method="post">
                ...
                <div class="text-right">
                    <a href="{{ route('admin.cms.corevalue') }}" class="btn btn-danger btn-sm">Reset</a>
        ...
        <div class="d-flex justify-content-between py-3 d-none">
            <a href="{{ route('admin.cms.add_corevalue') }}">
                        ...
                        @foreach ($data as $userKey => $user)
                            ...
                            <tr class="tr_row_{{ $userKey }}">
                                ...
                                <td>
                                    ...
                                    @else
                                    <img style="height:40px; width:50px" src="{{asset('images/team/commeties.png')}}" > 
                                    @endif
                            </td>
                                <td>
                                ...
                                <td>
                                    <div class="tableOptions">
                                        <span class="text-dark" title="Edit">
                                            <a href="{{ route('admin.cms.edit_corevalue', $user->id) }}"><i
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', '#userStatus', function(e) {
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        $.ajax({
                            url: "{{ route('admin.cms.status_corevalue') }}",
                            method: 'POST',
                            data: {
                                _method: 'post',
                                _token: '{{ csrf_token() }}',
            ...
            $(document).on('click', '#deleteUserBtn', function(e) {
                ...
                var uid = $(this).attr('uid');
                var urow = $(this).attr('urow');
                var url = `{{ url('/admin/cms/destroy-corevalue/${uid}') }}`;
