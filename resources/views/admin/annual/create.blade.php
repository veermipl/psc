...
@section('title', 'Annul Reports')

@section('content')

    <div class="p-3 bg-white">
        <h5 class="fw-bold">Create Annul Reports</h5>

        <div class="pt-5">
            <form action="{{ route('admin.readines.annul.store') }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('post')
                <div class="d-flex">
