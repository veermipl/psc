...
@section('title', 'National Budget - Create Source')
...
@section('content')
    ...
    <div class="p-3 bg-white">
        ...
        <h5 class="fw-bold">Create National Budget - Source</h5>

        <div class="pt-5">
            <form action="{{ route('admin.data.national-budget.save-source') }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('post')
