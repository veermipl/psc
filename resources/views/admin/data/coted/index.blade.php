    ...
    <div class="p-3 bg-white">
        ...
        <div class="pt-5">
            <div id="">
                ...
                <button class="btn btn-sm sub_page_link {{ ($tab == 'entrepreneurship_development') ? 'btn-custom' : 'btn-outline-custom' }}" id="sub_page_link_entrepreneurship_development" type="button" data-target="entrepreneurship_development">
            ...
            <div id="" class="pt-3">
                <div class="collapse sub_page_body {{ ($tab == 'main') ? 'show' : 'hide' }}" id="sub_page_body_main">
                    <div class="card card-body">
                        <form action="{{ route('admin.data.coted.update') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('post')
                ...
                <div class="collapse sub_page_body {{ ($tab == 'entrepreneurship_development') ? 'show' : 'hide' }}" id="sub_page_body_entrepreneurship_development">
                    <div class="card card-body">
                        <div class="d-flex justify-content-between py-3 d-none">
                            <a href="{{ route('admin.data.coted.create-entrepreneurship-development') }}">
                            ...
                            @if ($entrepreneurship_development_export_id && count($entrepreneurship_development_export_id) > 0)
                                <form action="" method="post" class="d-none">
                                    ...
                                    <input type="hidden" value="{{ implode(',', $entrepreneurship_development_export_id) }}" name="export_id">
                        ...
                        <div class="table-responsive">
                            <table id="cotedEntrepreneurshipDevelopmentTable" class="table table-sm table-borderless table-light" data-toggle="table" data-search="true"
                                                ...
                                                <td>
                                                    <div class="tableOptions">
                                                        <span class="text-dark" title="Edit">
                                                            <a href="{{ route('admin.data.coted.edit-entrepreneurship-development', $listValue->id) }}"><i
