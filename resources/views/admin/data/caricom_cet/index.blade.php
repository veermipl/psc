...
@section('content')
    ...
    <div class="p-3 bg-white">
        <h5 class="fw-bold">Caricom CET</h5>
        ...
        <div class="pt-5">
            <div id="">
                ...
                <button class="btn btn-sm sub_page_link {{ ($tab == 'objective') ? 'btn-custom' : 'btn-outline-custom' }}" id="sub_page_link_objective" type="button" data-target="objective">
                    Objective
                </button>
            </div>
            ...
            <div id="" class="pt-3">
                <div class="collapse sub_page_body {{ ($tab == 'main') ? 'show' : 'hide' }}" id="sub_page_body_main">
                    <div class="card card-body">
                        <form action="{{ route('admin.data.caricom-cet.update') }}" method="post" enctype="multipart/form-data">
                            @csrf
                            @method('post')
                ...
                <div class="collapse sub_page_body {{ ($tab == 'objective') ? 'show' : 'hide' }}" id="sub_page_body_objective">
                    <div class="card card-body">
                        <div class="d-flex justify-content-between py-3 d-none">
                            ...
                            @if ($objective_export_id && count($objective_export_id) > 0)
                                <form action="" method="post" class="d-none">
                                    ...
                                    <input type="hidden" value="{{ implode(',', $objective_export_id) }}" name="export_id">
                                                ...
                                                <td>
                                                    <div class="tableOptions">
                                                        <span class="text-dark" title="Edit">
                                                            <a href="{{ route('admin.data.caricom-cet.edit-objective', $listValue->id) }}"><i
