...
@section('content')
    ...
    <div class="p-3 bg-white">
        ...
        <h5 class="fw-bold">Update Caricom CET - Objective</h5>

        <div class="pt-5">
            <form action="{{ route('admin.data.caricom-cet.update-objective') }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('post')
                ...
                <div class="form-group col-md-12 text-right">
                    <button class="btn btn-sm btn-custom" type="submit">Update Caricom CET</button>
                </div>
            </form>
        </div>
    </div>
