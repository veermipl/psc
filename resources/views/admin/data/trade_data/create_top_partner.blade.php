...
@section('title', 'Trade Data - Create Top Partner')
...
@section('content')
    ...
    <div class="p-3 bg-white">
        ...
        <h5 class="fw-bold">Create Trade Data - Top Partner</h5>

        <div class="pt-5">
            <form action="{{ route('admin.data.trade-data.save-top-partner') }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('post')
                ...
                <div class="form-group col-md-12 text-right">
                    <button class="btn btn-sm btn-custom" type="submit">Create Top Partner</button>
                </div>
            </form>
        </div>
    </div>
