            ...
            <div class="card-body">
                <div class="p-4 border rounded">
                    <div id="">
                        ...
                        <button class="btn btn-sm sub_page_link {{ $tab == 'top_partner' ? 'btn-custom' : 'btn-outline-custom' }}"
                            id="sub_page_link_top_partner" type="button" data-target="top_partner">
                            Top Partner
                        </button>
                        <button class="btn btn-sm sub_page_link {{ $tab == 'top_country' ? 'btn-custom' : 'btn-outline-custom' }}"
                    ...
                    <div id="" class="pt-4">
                            ...
                            <div class="row">
                                <div class="col-lg-12 mb-3">
                                    <div class="d-flex justify-content-between">
                                        <a href="{{ route('admin.data.trade-data.create-top-partner') }}" class="btn btn-primary btn-sm">
                                            <ion-icon name="add" role="img" class="md hydrated" aria-label="person add"></ion-icon>Create Top Partner
                                        </a>
                                        ...
                                        @if ($top_partner_export_id && count($top_partner_export_id) > 0)
                                            <form action="" method="post" class="d-none">
                                                ...
                                                <input type="hidden" value="{{ implode(',', $top_partner_export_id) }}"
                                                    name="export_id">
                                ...
                                <div class="table-responsive">
                                    <table id="tradeDataTopPartnerTable" class="table table-sm table-borderless table-light"
                                        data-toggle="table" data-search="true" data-buttons-prefix="btn-md btn"
                        ...
                        <div class="collapse sub_page_body {{ $tab == 'top_country' ? 'show' : 'hide' }}"
                            ...
                            <div class="row">
                                <div class="col-lg-12 mb-3">
                                    <div class="d-flex justify-content-between">
                                        <a href="{{ route('admin.data.trade-data.create-top-country') }}" class="btn btn-primary btn-sm">
                                            <ion-icon name="add" role="img" class="md hydrated" aria-label="person add"></ion-icon>Create Top Country
                                        </a>
                                        ...
                                        @if ($top_country_export_id && count($top_country_export_id) > 0)
                                            <form action="" method="post" class="d-none">
                                                ...
                                                <input type="hidden" value="{{ implode(',', $top_country_export_id) }}"
                                                    name="export_id">
                                ...
                                <div class="table-responsive">
                                    <table id="tradeDataTopCountryTable" class="table table-sm table-borderless table-light"
                                        data-toggle="table" data-search="true" data-buttons-prefix="btn-md btn"
                                        data-pagination="true">
                                        <thead>
                                            <tr>
