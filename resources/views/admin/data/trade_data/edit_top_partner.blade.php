...
@section('title', 'Trade Data - Update Top Partner')
...
@section('content')
    ...
    <div class="p-3 bg-white">
        ...
        <h5 class="fw-bold">Update Trade Data - Top Partner</h5>

        <div class="pt-5">
            <form action="{{ route('admin.data.trade-data.update-top-partner') }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('post')
                ...
                <div class="form-group col-md-12 text-right">
                    <button class="btn btn-sm btn-custom" type="submit">Update Top Partner</button>
                </div>
            </form>
        </div>
    </div>
