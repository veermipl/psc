...
@section('title', 'Procurement Process in Guyana- List')
@section('header', 'Procurement Process in Guyana Data')

@section('content')

    <div class="page-breadcrumb d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">Procurement Process in Guyana Data</div>
    </div>
                    ...
                    <div class="p-4 border rounded">
                        ...
                        <div id="" class="pt-4">
                            <div class="collapse sub_page_body {{ $tab == 'main' ? 'show' : 'hide' }}"
                                ...
                                <form action="{{ route('admin.readines.procurement_update') }}" method="post" enctype="multipart/form-data" class="row g-3 needs-validation">
                                    @csrf
                                    @method('post')
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-3">
                                        <div class="d-flex justify-content-between">
                                            <a href="{{ route('admin.readines.methods.add') }}"
                                                class="btn btn-primary btn-sm">
                                                <ion-icon name="add" role="img" class="md hydrated"
                                                    aria-label="person add"></ion-icon>Create  Procurement Methods 
                                            </a>
                                                            ...
                                                            <td>
                                                                <div class="tableOptions">
                                                                    <span class="text-dark" title="Edit">
                                                                        <a
                                                                            href="{{ route('admin.readines.methods.edit', $listValue->id) }}">
                                    ...
                                    <div class="col-lg-12 mb-3">
                                        <div class="d-flex justify-content-between">
                                            <a href="{{ route('admin.readines.services.add') }}"
                                                class="btn btn-primary btn-sm">
                                                <ion-icon name="add" role="img" class="md hydrated"
                                                    aria-label="person add"></ion-icon>Create Procurement Procedures
                                            </a>
                                                        ...
                                                        <tr class="tr_row_{{ $listKey }}">
                                                            ...
                                                            <td>
                                                                <div class="tableOptions">
                                                                    <span class="text-dark" title="Edit">
                                                                        <a
                                                                            href="{{ route('admin.readines.services.edit', $listValue->id) }}">
                                                                            <i class="fa fa-pencil"></i>
                                                                        </a>
                                                                    </span>
                                                                    <span class="text-danger" title="Delete"
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', '#listStatus', function(e) {
                ...
                // alert(ltype);
                var url = null;
                if (ltype == 'Procurement_methods') {
                    url = "{{ route('admin.readines.methods.status') }}";
                }
                if (ltype == 'Procurement_services') {
                    url = "{{ route('admin.readines.services.status') }}";
                }
            ...
            $(document).on('click', '#deleteListBtn', function(e) {
                ...
                var url = null;
                if (ltype == 'Procurement_methods') {
                    url = "{{ route('admin.readines.methods.destroy') }}";
                }
                if (ltype == 'Procurement_services') {
                    url = "{{ route('admin.readines.services.destroy') }}";
                }
