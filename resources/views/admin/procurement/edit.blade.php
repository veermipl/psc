...
@section('title', 'About - Performance')

@section('content')

    <div class="p-3 bg-white">
        <h5 class="fw-bold">Edit performance</h5>

        <div class="pt-5">
            <form action="{{ route('admin.readines.procurement_update') }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('post')
                <div class="d-flex">
                ...
                <div class="d-flex">
                    ...
                    <input type="hidden" value="Procurement" name="type">
                </div>
