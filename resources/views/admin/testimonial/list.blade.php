...
@section('content')
    ...
    <div class="p-3 bg-white">
        <h5 class="fw-bold">Testimonial List</h5>
        ...
        <div class="filter-wrapper my-3 p-3">
            <form action="#" method="post">
                ...
                <div class="text-right">
                    <a href="{{ route('admin.testimonial.list') }}" class="btn btn-danger btn-sm">Reset</a>
                                ...
                                <td>
                                    <div class="tableOptions">
                                        <span class="text-dark" title="Edit">
                                            <a href="{{ route('admin.testimonial.edit', $user->id) }}"><i
