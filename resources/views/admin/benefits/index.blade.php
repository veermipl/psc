...
@section('title', 'Business - Benefits of a certificate')
@section('header', 'Business')

@section('content')

    <div class="p-3 bg-white">
        <h5 class="fw-bold">Benefits of a certificate List</h5>
        ...
        <div class="filter-wrapper my-3 p-3">
            <form action="#" method="post">
                ...
                <div class="text-right">
                    <a href="{{ route('admin.readines.benefits') }}" class="btn btn-danger btn-sm">Reset</a>
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', '#deleteUserBtn', function(e) {
                ...
                var uid = $(this).attr('uid');
                var urow = $(this).attr('urow');
                var url = `{{ url('/admin/readines/benefits-destroy/${uid}') }}`;
