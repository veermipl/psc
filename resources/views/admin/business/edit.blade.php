...
@section('title', ' Business Readiness Desk - List')
@section('header', 'Business Readiness Desk')

@section('content')

    <div class="page-breadcrumb d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3"> Business Readiness Desk</div>
    </div>
                        ...
                        <div id="" class="pt-4">
                                                            ...
                                                            <td>
                                                                <div class="tableOptions">
                                                                    <span class="text-dark" title="Edit">
                                                                        <a
                                                                            href="{{ route('admin.readines.certificate.edit', $listValue->id) }}">
                            ...
                            <div class="collapse sub_page_body {{ $tab == 'top_country' ? 'show' : 'hide' }}"
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-3">
                                        <div class="d-flex justify-content-between">
                                            <a href="{{ route('admin.readines.benefits.add') }}"
                                                class="btn btn-primary btn-sm">
                                                <ion-icon name="add" role="img" class="md hydrated"
                                                    aria-label="person add"></ion-icon>Create Benefits of a certificate
                                            </a>
                                                        ...
                                                        <tr class="tr_row_{{ $listKey }}">
                                                            ...
                                                            <td>
                                                                <div class="tableOptions">
                                                                    <span class="text-dark" title="Edit">
                                                                        <a
                                                                            href="{{ route('admin.readines.benefits.edit', $listValue->id) }}">
                                                                            <i class="fa fa-pencil"></i>
                                                                        </a>
                                                                    </span>
                                                                    <span class="text-danger" title="Delete"
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', '#deleteListBtn', function(e) {
                ...
                var url = null;
                if (ltype == 'Business_certificate') {
                    url = "{{ route('admin.readines.certificate.destroy') }}";
                }
                if (ltype == 'Business_benefits') {
