...
@section('title', 'Business Readiness Desk')

@section('content')

    <div class="p-3 bg-white">
        <h5 class="fw-bold">Edit Business Readiness Desk</h5>

        <div class="pt-5">
            <form action="{{ route('admin.readines.update_business', $data->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('patch')
                <div class="d-flex">
