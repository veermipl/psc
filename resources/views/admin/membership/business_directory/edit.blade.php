...
@section('content')
    ...
    <div class="p-3 bg-white">
        ...
        <h5 class="fw-bold">Update Business Directory</h5>

        <div class="pt-5">
            <form action="{{ route('admin.membership.business-directory.update', $business_directory->id) }}" method="post" enctype="multipart/form-data">
                @csrf
                @method('patch')
                ...
                <div class="d-flex">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="name" class="form-control" name="name" placeholder="Enter name"
                            value="{{ old('name', $business_directory->name) }}" maxlength="50">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" id="sub_name" class="form-control" name="sub_name" placeholder="Enter sub name"
                            value="{{ old('sub_name', $business_directory->sub_name) }}" maxlength="50">
                ...
                <div class="form-group col-md-12 text-right">
                    <button class="btn btn-sm btn-custom" type="submit">Update Business Directory</button>
                </div>
            </form>
        </div>
    </div>
