        ...
        <div class="col-lg-12 mb-3">
            <div class="d-flex justify-content-between">
                ...
                @if ($export_id && count($export_id) > 0)
                    <form action="{{ route('admin.membership.business-directory.export') }}" method="post" class="d-none-">
                        @csrf
                        @method('post')
                                ...
                                @if ($list && count($list) > 0)
                                    @foreach ($list as $listKey => $listValue)
                                        <tr class="tr_row_{{ $listKey }}">
                                            ...
                                            <td>
                                                <a href="{{ route('admin.membership.business-directory.show', $listValue->id) }}"
                                            ...
                                            <td>
                                                {{ $listValue->membershipType ? $listValue->membershipType->name : '' }}
                                            </td>
                                            ...
                                            <td>
                                                <div class="tableOptions">
                                                    <span class="text-dark" title="Edit">
                                                        <a
                                                            href="{{ route('admin.membership.business-directory.edit', $listValue->id) }}">
