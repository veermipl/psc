            ...
            <div class="card radius-10">
                <div class="card-body">
                    <div class="p-4 border rounded">
                        <form action="{{ route('admin.settings.general') }}" method="post" enctype="multipart/form-data" class="row g-3 needs-validation">
                            @csrf
                            @method('patch')

                            <div class="col-md-6 position-relative">
                                <label for="validationTooltip01" class="form-label">App Name <span class="text-danger">*</span></label>
                            ...
                            <div class="col-md-6 position-relative">
                                ...
                                @if (isset($settings['app_logo']))
                                    ...
                                    <a href="{{ $settings['app_logo'] ? asset('storage/' . $settings['app_logo']) : '' }}" class="badge alert-primary text-dark" target="_blank">
                                        View Logo
                                    </a>
                                @endif
                            ...
                            <div class="col-md-6 position-relative">
                                <label for="validationTooltip01" class="form-label">Admin Mail <span class="text-danger">*</span></label>
