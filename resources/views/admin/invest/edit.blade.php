...
@section('title', 'IDB Invest Data - List')
@section('header', 'IDB Invest Data')

@section('content')

    <div class="page-breadcrumb d-sm-flex align-items-center mb-3">
        <div class="breadcrumb-title pe-3">IDB Invest Data</div>
    </div>
                    ...
                    <div class="p-4 border rounded">
                        ...
                        <div id="" class="pt-4">
                            <div class="collapse sub_page_body {{ $tab == 'main' ? 'show' : 'hide' }}"
                                ...
                                <form action="{{ route('admin.readines.update_idbinves') }}" method="post" enctype="multipart/form-data" class="row g-3 needs-validation">
                                    @csrf
                                    @method('post')
                                    ...
                                    <input type="hidden" value="IDBInvest" name="type">
                                        ...
                                        <div class="d-flex justify-content-between">
                                            <a href="{{ route('admin.readines.areas.add') }}"
                                                ...
                                                <ion-icon name="add" role="img" class="md hydrated"
                                                    aria-label="person add"></ion-icon>Create  Key Areas of Focus 
                                            </a>
                                                            ...
                                                            <td>
                                                                <div class="tableOptions">
                                                                    <span class="text-dark" title="Edit">
                                                                        <a
                                                                            href="{{ route('admin.readines.areas.edit', $listValue->id) }}">
                            ...
                            <div class="collapse sub_page_body {{ $tab == 'top_country' ? 'show' : 'hide' }}"
                                ...
                                <div class="row">
                                    <div class="col-lg-12 mb-3">
                                        <div class="d-flex justify-content-between">
                                            <a href="{{ route('admin.readines.IDB.add') }}"
                                                class="btn btn-primary btn-sm">
                                                <ion-icon name="add" role="img" class="md hydrated"
                                                    aria-label="person add"></ion-icon>Create IDB Investment Services
                                            </a>
                                                        ...
                                                        <tr class="tr_row_{{ $listKey }}">
                                                            ...
                                                            <td>
                                                                <div class="tableOptions">
                                                                    <span class="text-dark" title="Edit">
                                                                        <a
                                                                            href="{{ route('admin.readines.IDB.edit', $listValue->id) }}">
                                                                            <i class="fa fa-pencil"></i>
                                                                        </a>
                                                                    </span>
                                                                    <span class="text-danger" title="Delete"
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            $(document).on('click', '#listStatus', function(e) {
                ...
                if (ltype == 'idb_investment') {
                    url = "{{ route('admin.readines.IDB.status') }}";
                }
            ...
            $(document).on('click', '#deleteListBtn', function(e) {
                ...
                var url = null;
                if (ltype == 'key_areas') {
                    url = "{{ route('admin.readines.areas.destroy') }}";
                }
                if (ltype == 'idb_investment') {
