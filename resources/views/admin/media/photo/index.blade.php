...
@section('content')
    ...
    <div class="p-3 bg-white">
        <h5 class="fw-bold">Photo List</h5>

        <div class="filter-wrapper my-3 p-3">
            <form action="{{ route('admin.media-center.photo.filter') }}" method="post">
                @csrf
                @method('post')
                ...
                <div class="text-right">
                    <a href="{{ route('admin.media-center.photo.index') }}" class="btn btn-danger btn-sm">Reset</a>
        ...
        <div class="d-flex justify-content-between py-3 d-none">
            <a href="{{ route('admin.media-center.photo.create') }}">
        ...
        <div class="table-responsive">
            <table id="membershipTypeTable" class="table table-sm table-borderless table-light" data-toggle="table"
                                ...
                                <td>
                                    <div class="tableOptions">
                                        <span class="text-dark" title="Edit">
                                            <a href="{{ route('admin.media-center.photo.edit', $listValue->id) }}"><i
