...
@section('content')
    ...
    <div class="p-3 bg-white">
        <h5 class="fw-bold">Press Release List</h5>

        <div class="filter-wrapper my-3 p-3">
            <form action="{{ route('admin.media-center.press-release.filter') }}" method="post">
                @csrf
                @method('post')
                ...
                <div class="text-right">
                    <a href="{{ route('admin.media-center.press-release.index') }}" class="btn btn-danger btn-sm">Reset</a>
        ...
        <div class="d-flex justify-content-between py-3 d-none">
            <a href="{{ route('admin.media-center.press-release.create') }}">
                    ...
                    @if ($list && count($list) > 0)
                        @foreach ($list as $listKey => $listValue)
                            ...
                            <tr class="tr_row_{{ $listKey }}">
                                ...
                                <td>
                                    <a href="{{ route('admin.media-center.press-release.show', $listValue->id) }}" class="text-secondary">
                                        {{ $listValue->title }}
                                    </a>
                                </td>
